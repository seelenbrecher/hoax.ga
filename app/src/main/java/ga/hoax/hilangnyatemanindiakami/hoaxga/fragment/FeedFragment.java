...
public class FeedFragment extends Fragment {
    ...
    private void buildData(List<Post> posts) {
        ...
        user5.setId(5);
        user5.setName("name5");
        Post post1 = new Post(1, "Title 1", user1, new Date(100), "Content will be long enough for the content ya it is long enough for now but I dont know in the future");
        Post post2 = new Post(2, "Title 2", user2, new Date(200), "Content will be long enough for the content ya it is long enough for now but I dont know in the future");
